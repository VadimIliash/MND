...
m = int(input("Введіть значення параметру m (кількість значень функції відгуку в кожному експерименті) ( 5 <= m <= 20):"))
...
p_90 = [2.0, 2.17, 2.29, 2.39, 2.49, 2.62]
...
if 5 <= m <= 6:
    if R_uv1 < p_90[0] and R_uv2 < p_90[0] and R_uv3 < p_90[0]:
        Disp_odn()
    else:
        print("Дисперсія не однорідна")
elif 7 <= m <= 8:
    if R_uv1 < p_90[1] and R_uv2 < p_90[1] and R_uv3 < p_90[1]:
        Disp_odn()
    else:
        print("Дисперсія не однорідна")
elif 9 <= m <= 10:
    if R_uv1 < p_90[2] and R_uv2 < p_90[2] and R_uv3 < p_90[2]:
        Disp_odn()
    else:
        print("Дисперсія не однорідна")
elif 11 <= m <= 13:
    if R_uv1 < p_90[3] and R_uv2 < p_90[3] and R_uv3 < p_90[3]:
        Disp_odn()
    else:
        print("Дисперсія не однорідна")
elif 14 <= m <= 17:
    if R_uv1 < p_90[4] and R_uv2 < p_90[4] and R_uv3 < p_90[4]:
        Disp_odn()
    else:
        print("Дисперсія не однорідна")
elif 18 <= m <= 20:
    if R_uv1 < p_90[5] and R_uv2 < p_90[5] and R_uv3 < p_90[5]:
        Disp_odn()
    else:
        print("Дисперсія не однорідна")
else:
    print("Введена некоректне значення параметру m (таблиця не розрахована на таку кількість значень функції відгуку)")