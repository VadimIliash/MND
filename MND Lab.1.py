...
Xn2 = []
Xn3 = []
#За допомогою циклу на 62 стрічці я знаходжу нормовані значення Xn для кожного фактора X1, X2, X3 і додаю знайдені значення у відповідні списки Xn1, Xn2, Xn3.
for i in range(0, 3):
    if i == 0:
        for j in range(0, 8):
